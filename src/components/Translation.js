            ...
            <div className="container px-5 py-8 mx-auto">
                <div className="text-center mb-20">
                    ...
                    <p className="text-base leading-relaxed w-full sm:w-2/3 mx-auto">
                        I started self-teaching Japanese in fall of 2020 - leveraging my knowledge of Chinese
                ...
                {translations.map((translation) => (
                    <div className="flex flex-row justify-center mb-8">
                        <div className="flex flex-col w-2/3 sm:w-1/3 justify-start">
                            <h1 className="flex-shrink mr-8 1 text-left underline font-medium text-red">
                        ...
                        <img className="w-1/4 place-self-start " src={translation.image}></img>
                    </div>
                ))}
            </div>
        </section>
